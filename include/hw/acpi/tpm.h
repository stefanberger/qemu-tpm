...
#define TPM_TIS_CAP_INTERRUPT_EDGE_RISING (1 << 5)
#define TPM_TIS_CAP_INTERRUPT_LOW_LEVEL  (1 << 4) /* support is mandatory */
#define TPM_TIS_CAP_INTERRUPT_HIGH_LEVEL (1 << 3)
#define TPM_TIS_CAPABILITIES_SUPPORTED1_3 \
    (TPM_TIS_CAP_INTERRUPT_LOW_LEVEL | \
     TPM_TIS_CAP_INTERRUPT_HIGH_LEVEL | \
     TPM_TIS_CAP_INTERRUPT_EDGE_RISING | \
